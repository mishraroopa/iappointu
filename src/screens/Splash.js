    ...
    <View style={{ backgroundColor: '#F1B4BB', flex: 1 }}>
      ...
      <View style={{ marginTop: 30 }}>
        <Text
          ...
          A Simple Convenient and User Friendly
        </Text>
        <Text
          style={{
            fontFamily: 'Poppins-SemiBold',
          ...
          way to book an appointment for
        </Text>
        <Text
          style={{
            fontFamily: 'Poppins-SemiBold',
      ...
      <View>
        <Image
          ...
          style={{ width: '33%', height: '79%', marginLeft: '-3%', top: '5%' }}
        />
      </View>

      <View>
        <Image
          source={require('../Assets/img/doctorji.png')}
          style={{
            width: '58%',
            height: '70%',
            top: '-87%',
      ...
      <View>
        <Image
          source={require('../Assets/img/rightsplash.png')}
